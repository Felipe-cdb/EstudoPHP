...
//Versão continua estática, a estrutura da matriz é igual a versão 1.5, mas aqui já implementamos funções de busca.
$galpao = [
...
//Função de busca, pecorre a matriz conforme o código de imprimir matriz, mas há uma condição para imprimir somente os produtos buscado
